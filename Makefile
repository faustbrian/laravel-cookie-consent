...
.PHONY: code-coverage
code-coverage: vendor ## Collects code coverage from running unit tests with pestphp/pest
	vendor/bin/pest --parallel --coverage-text
...
.PHONY: tests
tests: vendor ## Runs unit and end-to-end tests with pestphp/pest
